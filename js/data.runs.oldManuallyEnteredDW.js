...
var runs = [
	...
	//,[id:canyontrail,		label:"Canyon Trail",difficulty:0}
	...
	//,{id:mclaughlinsshoulder,"McLaughlin's Shoulder",difficulty:0}
	,{id:"mensdownhill",		label:"Men's Downhill",difficulty:70}
	,{id:"outeredge",		label:"Outer Edge",difficulty:0}
	//,{id:playground:		label:"Playground",difficulty:0}
	...
	//{id:telecom,			label:"Telecom",difficulty:0}
	...
	,{id:"womensdownhill",	label:"Women's Downhill",difficulty:70}
