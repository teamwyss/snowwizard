...
var runs = [
	...
	,{id:"boggycreek", label:"Boggy Creek", difficulty:55, show:false}
	...
	,{id:"chamois", label:"Chamois", difficulty:70, show:false}
	...
	,{id:"fannysfinish", label:"Fanny's Finish", difficulty:95, show:false}
	...
	,{id:"gliders", label:"Gliders", difficulty:5, show:false}
	,{id:"happyfeet", label:"Happy Feet", difficulty:5, show:false}
	,{id:"hoggsback", label:"Hoggs Back", difficulty:75, show:true}
	...
	,{id:"mensdownhill", label:"Men's Downhill", difficulty:75, show:false}
	...
	,{id:"wenzelsweave", label:"Wenzels Weave", difficulty:50, show:false}
